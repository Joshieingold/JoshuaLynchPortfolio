...
const ProjectCard = ({ title, description, image, githubLink }) => {
    ...
    return (
        <div>
            ...
            >
                {!expanded && (
                    <h2 className="titleOutsideBox">{title}</h2>
                )}
                {expanded && (
                    <div className="card-content">
                        <div className="card-details">
                            <h2 className="titleInsideBox">{title}</h2>
                            <p>{description}</p>
                        </div>
        ...
        <section id="works">
            ...
            <div className="worksSnapshots">
                <ProjectCard
                    ...
                    description="A simple and compact tool specializing in utilities for a warehouse administrator."
                    image={WarehouseToolbox}
                    githubLink="https://github.com/Joshieingold/Excel-Import-Tool"
                />
                <ProjectCard
